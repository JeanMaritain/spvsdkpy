...
PYBIND11_MODULE(spvsdkpy, m){
    m.doc() = "spv sdk pybind11 interface";
    ...
    py::enum_<BalanceType>(m, "BalanceType")
            .value("Default", BalanceType::Default)
            .value("Voted", BalanceType::Voted)
            .value("Total", BalanceType::Total)
            .export_values();
